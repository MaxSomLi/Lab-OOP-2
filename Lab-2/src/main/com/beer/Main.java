package main.com.beer;



import main.com.beer.parsers.DomBeerParser;
import main.com.beer.parsers.SaxBeerParser;
import main.com.beer.parsers.StaxBeerParser;
...
public class Main {
    public static void main(String[] args) throws Exception {
        List<BeerItemType> beers = new StaxBeerParser().parse("src/main/resources/beer.xml", "src/main/resources/beer.xsd");
